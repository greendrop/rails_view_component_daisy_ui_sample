...
module DaisyUi
  # @logical_path components/daisy_ui/soft_button
  class SecondarySoftButtonComponentPreview < Lookbook::Preview
    COMPONENT_CLASS = DaisyUi::SecondarySoftButtonComponent
