...
module DaisyUi
  # @logical_path components/daisy_ui/success_alert
  class SuccessAlertComponentPreview < Lookbook::Preview
    COMPONENT_CLASS = DaisyUi::SuccessAlertComponent
        ...
        safe_join(
          [
            render_component_outside_view_context(
              DaisyUi::SuccessAlertIconComponent.new
            ),
            render_component_outside_view_context(
          ...
          [
            ...
            render_component_outside_view_context(
              DaisyUi::AlertActionComponent.new.with_content(
                render_component_outside_view_context(
                  DaisyUi::SuccessButtonComponent.new(size: DaisyUi::SuccessButtonComponent::SIZE_SMALL).with_content('Action')
                )
              )
            )
          ]
