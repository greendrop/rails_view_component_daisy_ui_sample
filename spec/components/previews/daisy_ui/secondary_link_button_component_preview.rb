...
module DaisyUi
  # @logical_path components/daisy_ui/link_button
  class SecondaryLinkButtonComponentPreview < Lookbook::Preview
    COMPONENT_CLASS = DaisyUi::SecondaryLinkButtonComponent
