...
module DaisyUi
  # @logical_path components/daisy_ui/warning_alert
  class WarningAlertComponentPreview < Lookbook::Preview
    COMPONENT_CLASS = DaisyUi::WarningAlertComponent
        ...
        safe_join(
          [
            render_component_outside_view_context(
              DaisyUi::WarningAlertIconComponent.new
            ),
            render_component_outside_view_context(
          ...
          [
            ...
            render_component_outside_view_context(
              DaisyUi::AlertActionComponent.new.with_content(
                render_component_outside_view_context(
                  DaisyUi::WarningButtonComponent.new(size: DaisyUi::WarningButtonComponent::SIZE_SMALL).with_content('Action')
                )
              )
            )
          ]
