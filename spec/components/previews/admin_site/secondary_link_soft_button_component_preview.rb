...
module AdminSite
  # @logical_path components/admin_site/link_soft_button
  class SecondaryLinkSoftButtonComponentPreview < Lookbook::Preview
    COMPONENT_CLASS = AdminSite::SecondaryLinkSoftButtonComponent
