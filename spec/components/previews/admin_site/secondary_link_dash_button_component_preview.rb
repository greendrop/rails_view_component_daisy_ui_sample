...
module AdminSite
  # @logical_path components/admin_site/link_dash_button
  class SecondaryLinkDashButtonComponentPreview < Lookbook::Preview
    COMPONENT_CLASS = AdminSite::SecondaryLinkDashButtonComponent
