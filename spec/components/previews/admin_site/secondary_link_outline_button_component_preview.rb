...
module AdminSite
  # @logical_path components/admin_site/link_outline_button
  class SecondaryLinkOutlineButtonComponentPreview < Lookbook::Preview
    COMPONENT_CLASS = AdminSite::SecondaryLinkOutlineButtonComponent
