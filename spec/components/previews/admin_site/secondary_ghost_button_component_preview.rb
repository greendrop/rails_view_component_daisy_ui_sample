...
module AdminSite
  # @logical_path components/admin_site/ghost_button
  class SecondaryGhostButtonComponentPreview < Lookbook::Preview
    COMPONENT_CLASS = AdminSite::SecondaryGhostButtonComponent
