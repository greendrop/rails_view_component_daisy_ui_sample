...
module AdminSite
  # @logical_path components/admin_site/error_alert
  class ErrorAlertComponentPreview < Lookbook::Preview
    COMPONENT_CLASS = AdminSite::ErrorAlertComponent
        ...
        safe_join(
          [
            render_component_outside_view_context(
              AdminSite::ErrorAlertIconComponent.new
            ),
            render_component_outside_view_context(
          ...
          [
            ...
            render_component_outside_view_context(
              AdminSite::AlertActionComponent.new.with_content(
                render_component_outside_view_context(
                  AdminSite::ErrorButtonComponent.new(size: AdminSite::ErrorButtonComponent::SIZE_SMALL).with_content('Action')
                )
              )
            )
          ]
