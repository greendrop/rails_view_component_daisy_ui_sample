...
module AdminSite
  # @logical_path components/admin_site/outline_button
  class SecondaryOutlineButtonComponentPreview < Lookbook::Preview
    COMPONENT_CLASS = AdminSite::SecondaryOutlineButtonComponent
