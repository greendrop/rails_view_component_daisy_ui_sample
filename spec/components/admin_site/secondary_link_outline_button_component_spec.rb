...
RSpec.describe AdminSite::SecondaryLinkOutlineButtonComponent, type: :component do
  describe 'snapshot' do
    ...
    context 'activeがtrue' do
      let!(:instance) do
        described_class.new(url: '#', active: true).with_content('Active')
      end
    ...
    context 'disabledがtrue' do
      let!(:instance) do
        described_class.new(url: '#', disabled: true).with_content('Disabled')
      end
    ...
    context 'wideがtrue' do
      let!(:instance) do
        described_class.new(url: '#', active: true).with_content('Wide')
      end
    ...
    context 'blockがtrue' do
      let!(:instance) do
        described_class.new(url: '#', active: true).with_content('Block')
      end
    ...
    context 'squareがtrue' do
      let!(:instance) do
        described_class.new(url: '#', square: true).with_content('S')
      end
    ...
    context 'circleがtrue' do
      let!(:instance) do
        described_class.new(url: '#', square: true).with_content('C')
      end
